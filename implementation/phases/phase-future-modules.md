...
## Epic F1: Notes Module Screen
- [ ] Feature: Notes API service
- [ ] Feature: Fixed Cards (Recent Notes list)
- [ ] Feature: Widget (Quick Add Note)

## Epic F2: Kitchen Utilities Screen
- [ ] Feature: Utilities API service
- [ ] Feature: Fixed Cards (Current Gas Level, Order History)
