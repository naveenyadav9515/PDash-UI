...
## Epic 11.1: Edit Mode State

### Feature 11.1.1: Edit Mode Service
- [ ] Create `core/services/edit-mode.service.ts`
- [ ] `isEditMode` signal (default: false)
- [ ] `toggleEditMode()` method

### Feature 11.1.2: Edit Mode UI Bindings
...
## Epic 11.2: Three-Tier Removal UI

### Feature 11.2.1: Operation 1 (Dashboard)
...
### Feature 11.2.2: Operation 2 & 3 (Module Management)
